            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        cx, cy = plot_one_box(xyxy, im0, label=label, color=colors[int(cls)], line_thickness=3)
                        cx_list.append(cx)
                        cy_list.append(cy)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iou-thres', type=float, default=0.45, help='IOU threshold for NMS')  # 交并比来消除框
